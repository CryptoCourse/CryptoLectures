Режим CBC и CTR. IV = 16 байт. IV добавлен к зашифрованному тексту в начале. PKCS5 padding (дополнение, см [википедия](https://en.wikipedia.org/wiki/Padding_(cryptography)#PKCS%235_and_PKCS%237))

Расшифровать шифртексты на вашем любимом языке программирования.
